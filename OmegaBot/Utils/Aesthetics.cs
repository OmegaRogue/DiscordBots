...
namespace OmegaBot.Utils
{
	public static class Aesthetics
	{
		...
		public static async Task<string> ContructLineAsync(int x, int y)
		{
		...
		public static async Task<string> ToBlockTextAsync(this string input)
		{
			...
			lineBuffer1 = lineBuffer1.Substring(0, lineBuffer1.Length - 2);
			lineBuffer2 = lineBuffer2.Substring(0, lineBuffer2.Length - 2);
			lineBuffer3 = lineBuffer3.Substring(0, lineBuffer3.Length - 2);
			lineBuffer4 = lineBuffer4.Substring(0, lineBuffer4.Length - 2);
			lineBuffer5 = lineBuffer5.Substring(0, lineBuffer5.Length - 2);
